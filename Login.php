...
<html>
   ...
   <body bgcolor = "#FFFFFF">       
      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333;margin-top: 250px; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "" method = "post">
                 ...
                 <input type = "password" name = "password" placeholder="Password" class = "box" /><br/><br />
                  <input type = "submit" value = " Login " style="background-color: #4286f4;margin-left: 50px;color: white;"/><br />
               </form>
